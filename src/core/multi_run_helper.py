...
def validate_jsx_package(package_path):
    ...
    return os.path.exists(package_json_path) or os.path.exists(js_path) or os.path.exists(jsx_path) or os.path.exists(ts_path) or os.path.exists(tsx_path)
...
def get_entrance_files_of_jsx_package(package_path: str, get_all=False, options=None) -> List[str]:
    ...
    with open(package_json_path, 'r') as f:
        ...
        common_entrances.extend([
            'src/index', 'index', 'src/app', 'app',
            'src/main', 'main', 'src/pages/App',   'client/src/index',
        ])
